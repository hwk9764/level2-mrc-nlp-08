...
def search_evaluation(q_encoder, tokenizer, test_dataset, faiss_index, text_index, text, title, 
    ...
    # shape : (600, 138564) = (test 질문 수, passage 수)
    with open("./database/pickles_kiwi_main_hf_dpr/test_bm25_kiwi_main-hf-dpr_scores.pkl", 'wb') as file:
        pickle.dump(bm25_scores, file)
    
    with open("./database/pickles_kiwi_main_hf_dpr/test_bm25_kiwi_main-hf-dpr_scores.pkl", 'rb') as file:
    ...
    get_topk_document(question_test_idx, question, question_idx, text_index, text, title, "./resources/retrieval/top40_bm25_retrieval_dataset")
    ...
    get_topk_document(I, question, question_idx, text_index, text, title, "./resources/retrieval/top40_dpr+bm25_retrieval_dataset")
...
def main(args):
    ...
    test_dataset = datasets['validation'].to_pandas()
...
def argument_parser():
    ...
    parser.add_argument('--search_k', default=10000, type=int,
